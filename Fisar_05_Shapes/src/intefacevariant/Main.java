...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //může obsahovat cokoli, co je typově kompatibilní s ShapeInterface (Circle, Rectangle)
        //ShapeInterface s = new Rectangle(5,6);  --je ok, protože extended
        //Rectangle r = new ShapeInterface(); -- není ok, protože není extended tímto směrem (funguje jen na jednu stranu)
        shapes3.add(c1);
        shapes3.add(r1);
